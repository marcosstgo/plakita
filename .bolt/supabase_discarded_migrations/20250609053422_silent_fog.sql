-- Migración corregida para evitar errores de políticas duplicadas
...
-- Eliminar políticas existentes de pets antes de recrearlas
...
-- Política para permitir lectura pública de pets activados

/*
  ...
  2. Security
    - Update RLS policies for tags and pets
    - Allow public access to activated tags
    - Ensure proper user permissions

  3. Data Consistency
    - Clean up inconsistent data
    - Sync activation states between pets and tags
*/
...
-- Política para permitir lectura pública de mascotas activadas
CREATE POLICY "Public can read activated pets"
  ON pets
  FOR SELECT
  TO anon

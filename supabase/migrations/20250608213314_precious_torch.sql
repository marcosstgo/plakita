...
-- Agregar foreign keys correctas solo si no existen
DO $$
BEGIN
...
-- Actualizar políticas RLS para tags (eliminar solo si existen)
...
-- Actualizar políticas RLS para pets (eliminar solo si existen)
